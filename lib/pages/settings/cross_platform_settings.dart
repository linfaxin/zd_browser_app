...
class _CrossPlatformSettingsState extends State<CrossPlatformSettings> {
  ...
  List<Widget> _buildBaseSettings() {
    ...
    var widgets = <Widget>[
      ...
      SwitchListTile(
        title: const Text("已启用调试"),
        subtitle: const Text(
            "启用对本应用任意 WebView 中加载网页内容的调试。在 iOS < 16.4 上，调试模式始终开启。"),
      ...
      FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return ListTile(
            title: const Text("Flutter 浏览器包信息"),
  ...
  List<Widget> _buildWebViewTabSettings() {
    ...
    var widgets = <Widget>[
      ...
      SwitchListTile(
        title: const Text("已启用 JavaScript"),
        subtitle:
      ...
      SwitchListTile(
        ...
        subtitle: const Text(
            "设置 WebView 是否不支持通过屏幕缩放控件和手势进行缩放。"),
      ...
      SwitchListTile(
        title: const Text("允许从 file URL 访问文件"),
        subtitle: const Text(
            "设置是否允许 file 协议 URL 上下文中的 JavaScript 访问其他 file 协议 URL 的内容。"),
        value:
      ...
      SwitchListTile(
        title: const Text("允许从 file URL 进行通用访问"),
        subtitle: const Text(
            "设置是否允许 file 协议 URL 上下文中的 JavaScript 访问任意来源的内容。"),
